...
CompleteDataLLRcpp <- function(d, alpha0, beta0, alphaS, betaS, z, 
                               w, alternative = "greater", mciter = 50) {
  if (length(alpha0) == 1) {
  ...
  result <- .Call("CompleteDataLLRcpp", d[, "ns"], d[, "Ns"], d[, 
                                                                "nu"], d[, "Nu"], alpha0, beta0, alphaS, betaS, z, w, alternative, 
