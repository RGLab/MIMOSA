...
#' @docType class
#' @rdname MCMCResult
setClass("MCMCResult",representation=list(z="matrix",n.stim="data.frame",n.unstim="data.frame",params="matrix",p="list",phenoData="AnnotatedDataFrame"))
...
MCMCResult<-function(object=NULL){
  if(class(object)=="MDMixResult"){
    if(is.null(names(object))){
      ...
      return(new("MCMCResult",z=object$z,n.stim=object$n.stim,n.unstim=object$n.unstim,params=object$params,p=object$p,phenoData=attr(object,"pData")))
    }
  }
}
...
#' 
#' @docType class
setClass("MIMOSAResult",representation=list(result="MixResult",z="matrix",w="numeric"))
