...
#'  @name .fitMCMC
#'  @export
.fitMCMC<-function(data,inits=NULL,iter=250000, burn=50000, thin=1,tune=100,outfile="mcmc.dat",alternative="greater",UPPER=0.5,LOWER=0.15,FAST=TRUE,EXPRATE=1e-4){
