...
% ifng<-BetaMix(extractData(HVTN049.ics,stim="ENV-1-PTEG",control="negctrl1",subset=c("cd4","IFNg")),scl=5)
% tnfa<-BetaMix(extractData(HVTN049.ics,stim="ENV-1-PTEG",control="negctrl1",subset=c("cd4","TNFa")),scl=5)
% @
% 
